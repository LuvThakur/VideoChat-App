...
const initialState = {
  ...
  all_users: [], // work in backend not done yet
  chat_type: null,
  room_id: null,
  call_logs: []
};
  ...
  return async (dispatch, getState) => {
    ...
    await axios
      ...
      .then((response) => {
        ...
        dispatch(
          SidebarSlice.actions.updateUsers({ users: response.data.data })
        );
      })
      .catch((error) => {
        ...
        dispatch(
          SidebarSlice.actions.openSnackbar({
  ...
  return async (dispatch, getState) => {
    await axios
      ...
      .then((response) => {
        ...
        dispatch(
          SidebarSlice.actions.updateFriends({ friends: response.data.data })
        );
      })
      .catch((error) => {
  ...
  return async (dispatch, getState) => {
    ...
    await axios
      ...
      .then((response) => {
        ...
        dispatch(
          SidebarSlice.actions.updateFriendRequests({
  ...
  return async (dispatch, getState) => {
    ...
    await axios
      ...
      .then((response) => {
        ...
        dispatch(
          SidebarSlice.actions.profileFetch({ user: response.data.data })
        );
      })
      .catch((error) => console.log("fetch-profile", error));
  };
};
...
export const UpdateUserProfile = (formData) => {
  return async (dispatch, getState) => {
    ...
    await axios
      ...
      .catch((error) => console.log("update-prfile-err", error));
  };
};

export const FetchCall_Logs = () => {
  return async (dispatch, getState) => {
    axios
      .get("/user/get-callLogs", {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${getState().auth.token}`,
        },
      ...
      .then((response) => {
        console.log("fetc-call-logs==>", response);
        dispatch(
          SidebarSlice.actions.fetchCallLogs({ call_logs: response.data.data })
        );
      })
      .catch((error) => {
        console.log(error);

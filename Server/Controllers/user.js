...
exports.getFriends = async (req, res, next) => {
  try {
    ...
    const curr_user = await User.findById(this_user._id).populate(
      "friends",
...
exports.generateZegoToken = catchAsync(async (req, res, next) => {
  try {
    ...
    console.log("Zego-Id-body", req.body);
...
exports.getCallLogs = catchAsync(async (req, res, next) => {
  try {
    ...
    console.log("error while get-call logs",error);
  }
});

exports.startAudioCall = catchAsync(async (req, res, next) => {
//   console.log("from->", req.user, "to->", req.body ,"hedaer->", req.header);
